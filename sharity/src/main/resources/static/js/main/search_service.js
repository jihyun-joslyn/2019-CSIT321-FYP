...
fetch('https://uowfyp2020.herokuapp.com/service/getSearchResult?name=' + name, {
    method: 'GET',
    mode: 'cors',
    headers: {
    ...
    .then(responseJson => {
        ...
        for (var i = 0; i < len; i++) {
            ...
            td1a.href = "/servicedetails?pID=" + responseJson[i].productID;
            ...
            var td5node = document.createTextNode(responseJson[i].cid);
